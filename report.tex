...
All lemmas shown in the diagram have been fully formalized, with two exceptions. The lemma \\\texttt{exists\_extract\_or\_top} has not yet been completed, and the lower-bound lemma \texttt{never\_underestimates} is currently left as a \texttt{sorry}. The reasons these proofs remain unfinished are discussed in the corresponding sections on the following pages.
